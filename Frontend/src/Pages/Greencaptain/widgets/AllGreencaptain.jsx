...
function AllGreencaptain({ Greencaptainist, loading, setGreencaptainOne, districts, fetchMedicines }) {
	...
	const handleDeleteusers = async (id) => {
		try {
			if (!window.confirm('Are you sure you want to delete this Green captain?')) {
				return;
			}
...
export default AllGreencaptain;
